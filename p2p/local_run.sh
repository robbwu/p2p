...
tmux send-keys "./$BINARY_NAME -d ./1 -n $N -t $T" C-m

tmux select-pane -t 1
tmux send-keys "echo instance 2" C-m
tmux send-keys "./$BINARY_NAME -d ./2 -n $N -t $T" C-m

tmux select-pane -t 2
tmux send-keys "echo instance 2" C-m
tmux send-keys "./$BINARY_NAME -d ./3 -n $N -t $T" C-m


tmux select-pane -t 3
tmux send-keys "echo instance 2" C-m
tmux send-keys "./$BINARY_NAME -d ./4 -n $N -t $T" C-m
