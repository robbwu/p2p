...
N=3
T=1
MSGHASH="8bd574fdb05c2dc5017188a2f4c32d5b81963e0a33eccba92404e968c665006d"
...
tmux send-keys "./$BINARY_NAME keysign  --password $PASSWORD --token $TOKEN --vault test0 --msg-hash $MSGHASH" C-m

tmux select-pane -t 1
tmux send-keys "echo Running $BINARY_NAME on remote server..." C-m
tmux send-keys "ssh ex44 'cd $REMOTE_DIR && chmod +x $BINARY_NAME && ./$BINARY_NAME keysign  --password $PASSWORD --token $TOKEN --vault test0 --msg-hash $MSGHASH'" C-m
